...
const AboutHeader = () => {
  ...
  return (
    <>
      <div class="about-header__title-container">
        <div class="about-header__bg about-header__bg--gradient-1-dark">
          <div class="about_header_picture">
            <Image
              height={140}
              width={1500}
              class="about_header_bg_picture media__image media__element b-loaded is-b-loaded"
              src={AboutImage}
